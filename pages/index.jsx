    ...
    <Fragment>
      ...
      <main className="main-left">
        ...
        <section
          ...
          style={{ backgroundImage: "url(static/img/esraa.jpeg)" }}
        >
            ...
            <div className="row full-screen align-items-center p-100px-tb">
              <div className="col-md-6">
                <div className="ht-text">
                  ...
                  <p>
                  Passionate Frontend Web Developer dedicated to crafting responsive, user-friendly websites that deliver seamless experiences and positively impact people's lives through creative and innovative design.
                  </p>
